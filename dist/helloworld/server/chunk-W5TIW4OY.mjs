...
import{$ as je,A as D,B as L,C as Re,D as H,E as Se,F as Ee,G as we,H as u,I as d,J as p,K as xe,L as x,M as Fe,N as Oe,O as Me,P as R,Q as Ie,R as ke,S as Te,Y as _e,_ as P,a as T,b as ce,ba as Ae,c as _,ca as De,d as ae,da as Pe,e as ue,ea as Ue,f as le,fa as Ve,g as de,ga as Ze,h as pe,ha as Ne,i as fe,j as he,k as me,ka as ze,l as C,m as j,n as c,o as a,oa as $e,p as y,q as z,r as ge,ra as Le,s as A,t as ve,u as ye,v as b,w,x as Ce,y as $,z as be}from"./chunk-6YPUY4JU.mjs";import{a as v,b as k}from"./chunk-VVCT4QZE.mjs";function q(e,t){let i=!t?.manualCleanup;i&&!t?.injector&&ye(q);let n=i?t?.injector?.get($)??y($):null,r;t?.requireSync?r=H({kind:0}):r=H({kind:1,value:t?.initialValue});let o=e.subscribe({next:s=>r.set({kind:1,value:s}),error:s=>{if(t?.rejectErrors)throw s;r.set({kind:2,error:s})}});return n?.onDestroy(o.unsubscribe.bind(o)),P(()=>{let s=r();switch(s.kind){case 1:return s.value;case 2:throw s.error;case 0:throw new me(601,"`toSignal()` called with `requireSync` but `Observable` did not emit synchronously.")}})}var Y={};function it(e,t){if(Y[e]=(Y[e]||0)+1,typeof t=="function")return G(e,(...n)=>k(v({},t(...n)),{type:e}));switch(t?t._as:"empty"){case"empty":return G(e,()=>({type:e}));case"props":return G(e,n=>k(v({},n),{type:e}));default:throw new Error("Unexpected config.")}}function ot(){return{_as:"props",_p:void 0}}function G(e,t){return Object.defineProperty(t,"type",{value:e,writable:!1})}var st="@ngrx/store/init",S=(()=>{let t=class t extends _{constructor(){super({type:st})}next(n){if(typeof n=="function")throw new TypeError(`
  ...
  }`]});let e=t;return e})();var wt=[];var bn="",xt=Rt(bn,bt(I,(e,{title:t})=>t));var Ft={providers:[Le(wt),Ne(),Pe(Ue()),ve(Ct.forRoot({title:xt}))]};var Rn={providers:[ze()]},Ot=je(Ft,Rn);var Sn=()=>Ze(Et,Ot),vr=Sn;export{vr as a};
